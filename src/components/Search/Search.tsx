...
const Input = () => {
  ...
  return(
    <FormControl sx={{ width: '25vw', margin: 'calc(var(--gap) * 2) 0' }}>
      ...
      >
        <MenuItem value='' disabled><em>지점을 선택하세요</em></MenuItem>
    ...
    <SearchContainer>
      <SearchHeader bgImage={searchBg}>
        ...
        <div className="textWrapper">
          <h2 className='title' data-aos="flip-up" data-aos-duration="1000">지점 찾기</h2>
          <p className='desc' data-aos="flip-up" data-aos-duration="1000">가까운 지점을 만나보세요</p>
        </div>
      </SearchHeader>
